...
| [AUTH_IMPROVEMENTS_PHASE_01](./AUTH_IMPROVEMENTS_PHASE_01.md) | Critical Security | Partially Done — rate limiting, lockout & audit logging done; JWT key encryption pending |
| [AUTH_IMPROVEMENTS_PHASE_02](./AUTH_IMPROVEMENTS_PHASE_02.md) | High Impact | Partially Done — cookie `Secure` flag done; `SameSite`, TLS, HIBP, password history pending |
...
- RS256 JWT signing with automatic, advisory-lock-guarded key rotation, 3072-bit RSA.
